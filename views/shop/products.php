...
<!-- <section id="advertisement">
		<div class="container">
			<img src="<?=Url::base()?>/images/shop/advertisement.jpg" alt="" />
		</div>
	</section> -->
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<?php foreach ($getpag as $v): ?>
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<a href="<?=Url::to(['shop/product-details','id'=> $v->id])?>"><img src="<?=Url::base()?>/images/product/<?=$v->img?>" alt="">
												<h2><?=$v->narx?>so'm</h2>
												<p><?=$v->name?></p>
											</a>
